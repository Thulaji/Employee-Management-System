      ...
      <div class="header-wrapper">
        ...
        <div class="card-container">
          ...
          <div class="card-wrapper">
            <div class="activetask-card light-purple" onclick="redirectToAdminPage()">
              ...
              <?php
              $dash_employee_query="SELECT * FROM users WHERE userType='Admin'";
            ...
            <div class="activetask-card light-purple">
              <div class="card-header">
                <div class="task">
              ...
              <span class="card-details"> 13 </span>
            </div>
            <div class="activetask-card light-purple">
              <div class="card-header">
                <div class="task">
              ...
              <span class="card-details"> 16 </span>
            </div>
