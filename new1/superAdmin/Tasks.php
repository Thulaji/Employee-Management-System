...
form {
  ...
  margin-right: 20px; /* Add this for some margin between the form and right edge */
}
          ...
          <div class="table-container">
            <table>
              <thead>
                ...
                <tbody>
                <?php 
               $query = "SELECT task.TId, name, Startdate, Enddate, nature, EId FROM task INNER JOIN tuser ON tuser.TId = task.TId";
